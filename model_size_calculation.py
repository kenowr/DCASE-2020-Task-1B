#!/usr/bin/env python
# -*- coding: utf-8 -*-
# Model size calculation code written by DCASE 2020 Task 1B organisers
# Modified to work with TF2 by Kenneth Ooi.
import numpy
import dcase_util
...
def get_keras_model_size(keras_model, verbose=True, ui=None, excluded_layers=None):
    ...
    Parameters
    ----------
    keras_model : keras.models.Model or str
        keras model (or filepath leading to model) for the size calculation
    ...
    if excluded_layers is None:
        ...
        excluded_layers = []
        try:
            import tensorflow.keras as keras # Edited to work with TF2
