...
model_path = 'models' + os.sep + 'model1' + os.sep
...
## GENERATE VGG MODEL (MODEL 1)
model = vgg_prunable(**pruning_params)
print('Generated Model 1. Training it now...')

## TRAIN VGG MODEL
model_hist = trainp_model(model,train_features,train_labels,eval_features,eval_labels,
                          string = 'MODEL1_', model_path = model_path, batch_size = batch_size)

## FIND BEST MODEL
model_list = glob.glob('models' + os.sep + 'model1' + os.sep + 'weights' + os.sep + 'MODEL1_epoch-[3,4]*') # Get models from epoch 300-400 only because they are pruned.
...
_ = make_predictions(test_features, [best_filepath], output_filepath = submission_dir + 'Ooi_NTU_task1b_1.output.csv', delimiter = '\t', newline = '\n')
...
print()
print('============================')
print(' FINAL ANALYSIS FOR MODEL 1 ')
print('============================')
print()
